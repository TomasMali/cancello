...
bot.on('message', (msg) => {
  ...
  //    const LED = new Gpio(17, 'out'); //use GPIO pin 4, and specify that it is output
    ...
    if (msg.text.toString() === APRI_CANCELLO) {
        ...
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/carta_identita_tom.pdf")
    }
    else if (msg.text.toString().indexOf(CONTRATTO_TOMAMS) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/contratto_lav_tom.pdf")
    }
    else if (msg.text.toString().indexOf(CONTRATTO_CASA) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/ContrattoCasapdf.pdf")
    }
    else if (msg.text.toString().indexOf(LIBRETTO_CLIO) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/Libretto_Clio_2018.pdf")
    }
    //----
    else if (msg.text.toString().indexOf(PASS_TOMAS) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/passaporto_tom.pdf")
    }
    else if (msg.text.toString().indexOf(PERG_TOM) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/pergamena_tom.pdf")
    }
    else if (msg.text.toString().indexOf(PERMS_TOM) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/PermessoSubordianto_tom.pdf")
    }
    else if (msg.text.toString().indexOf(TESS_TOM) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/tesseraSanitaria_tom.pdf")
    }
    //---
    else if (msg.text.toString().indexOf(CARTA_IDEN_ORNELA) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/carta_di_identita_orn.pdf")
    }
    else if (msg.text.toString().indexOf(PERMES_ORNELLA) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/permessoOrnela.pdf")
    }
    else if (msg.text.toString().indexOf(CERT_MATT) === 0) {
        bot.sendDocument(msg.chat.id, "/Users/tomas/Desktop/cancello/files/CertificatoDiMatrimonio.pdf")
    }
